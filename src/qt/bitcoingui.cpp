    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("Pharma") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/pharma"));
    setWindowIcon(QIcon(":icons/pharma"));
#else
    //setUnifiedTitleAndToolBarOnMac(true);
    QApplication::setAttribute(Qt::AA_DontShowIconsInMenus);
#endif
    setObjectName("pharma");
    setStyleSheet("#pharma { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #efefef, stop: 1 #dedede);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Pharma address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/pharma"), tr("&Panacea Net"), this);
    ...
    aboutAction = new QAction(tr("&About Pharma"), this);
    aboutAction->setToolTip(tr("Show information about Pharma"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Pharma"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/pharma"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/pharma_testnet"));
            setWindowIcon(QIcon(":icons/pharma_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/pharma_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Pharma client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Pharma client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pharma network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Pharma address or malformed URI parameters."));
    }
