...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeXPHAmount"))
        settings.setValue("nAnonymizeXPHAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeXPHAmount = settings.value("nAnonymizeXPHAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeXPHAmount"))
        SoftSetArg("-anonymizeXPHamount", settings.value("nAnonymizeXPHAmount").toString().toStdString());
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case anonymizeXPHAmount:
            nAnonymizeXPHAmount = value.toInt();
            settings.setValue("nAnonymizeXPHAmount", nAnonymizeXPHAmount);
            emit anonymizeXPHAmountChanged(nAnonymizeXPHAmount);
            break;
