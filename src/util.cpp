...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Pharma
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Pharma
    // Mac: ~/Library/Application Support/Pharma
    // Unix: ~/.pharma
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Pharma";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "pharma.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "pharmad.pid"));
